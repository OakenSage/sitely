...
def generate_recurse(from_path, template_path, dest_path, basepath):
  ...
  for file in files:
      ...
      if os.path.isfile(file_path):
        ...
        generate_page(file_path, template_path, new_path, basepath)
      else:
        os.mkdir(des_path)
        generate_recurse(file_path,template_path,des_path,basepath)
...
def main():
  if os.path.exists("docs"):
    shutil.rmtree("docs")
  os.mkdir("docs")
  copy_path("static","docs")
  generate_recurse("content","template.html","docs",basepath)
